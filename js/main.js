...
// Enunciado: Crea una expresión regular que valide un nombre de usuario. 
// El nombre de usuario debe contener solo letras minúsculas y números, con longitud entre 3 y 10 caracteres.

const cosas = /^[a-z0-9]{3,10}$/;
